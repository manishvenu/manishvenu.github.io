...
I did this for a research project recently, so here is an option to get the deployment working: [Steps of Django Deployment on AWS](https://manishvenu.github.io/MLDjango/manualdocs/deploy_to_ec2.html).
